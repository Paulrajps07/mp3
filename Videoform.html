<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Videoform.aspx.cs" Inherits="MP3_Digital.Videoform" %>
...
<body onload="myfunction()">
    ...
    <div>
        ...
        <div id="v">
                ...
                <video src="bg%20video/bg.mp4" controls="controls" />
            </div>
            <div id="v">
                <h3>Sample video 2</h3>
                <video src="bg%20video/bg1.mp4" controls="controls" />
        </div><br />
