<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="babyshower.aspx.cs" Inherits="MP3_Digital.babyshower" %>
...
<body onload="myfunction()">
    ...
    <div>
        ...
        <div id="container">            <br /><br />          
            <asp:Panel ID="Panel1" runat="server" Width="100%" BorderWidth="0px"></asp:Panel>
