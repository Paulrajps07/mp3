...
{
    public partial class candidform : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            foreach (string strfilename in Directory.GetFiles(Server.MapPath("~/candid/")))
            {
                ImageButton imageButton = new ImageButton();
                FileInfo fileInfo = new FileInfo(strfilename);
                imageButton.ImageUrl = "~/candid/" + fileInfo.Name;
